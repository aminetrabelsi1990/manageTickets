...
class __TwigTemplate_ef2fb45f429fa56454b3601c2733d46526e62199053aee5b6d64ec0551968d6d extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("create_project"), "html", null, true);
        echo " ";
...
\t\t\t";
        // line 9
        $this->loadTemplate("partial/logoheader.html.twig", "project/create.html.twig", 9)->display($context);
        // line 10
        echo "\t\t\t<!-- End Logo Header -->
            ";
        // line 11
        $this->loadTemplate("partial/navbar.html.twig", "project/create.html.twig", 11)->display($context);
        // line 12
        echo "        </div>
        ";
        // line 13
        $this->loadTemplate("partial/sidebar.html.twig", "project/create.html.twig", 13)->display($context);
        // line 14
...
\t\t\t\t\t\t\t\t\t\t\t\t<a class=\"btn btn-danger\" href=\"";
        // line 58
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 58, $this->source); })()), "request", [], "any", false, false, false, 58), "headers", [], "any", false, false, false, 58), "get", [0 => "referer"], "method", false, false, false, 58), "html", null, true);
        echo "\">";
...
";
    ...
    {
        return array (  193 => 65,  188 => 62,  179 => 58,  175 => 57,  165 => 50,  161 => 49,  155 => 46,  152 => 45,  147 => 42,  135 => 35,  126 => 29,  112 => 18,  106 => 14,  104 => 13,  101 => 12,  99 => 11,  96 => 10,  94 => 9,  89 => 6,  79 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}{{ 'create_project'|trans }} {% endblock %}
...
\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t<li class=\"nav-item\">
\t\t\t\t\t\t\t\t<a href=\"#\">{{ 'New'|trans }} {{ 'Project'|trans }} </a>
\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t</ul>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"row\">
...
{% endblock %}
", "project/create.html.twig", "/Users/amine/Projects/manageTicket/templates/project/create.html.twig");
    }
}
