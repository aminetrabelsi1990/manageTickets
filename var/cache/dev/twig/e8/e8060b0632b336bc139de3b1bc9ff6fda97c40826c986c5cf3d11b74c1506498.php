...
class __TwigTemplate_78f0835562416700b3554a1343ae11888e47c7e4ce159dc862524a2ba0f7dc9c extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("create_admin"), "html", null, true);
        echo " ";
...
\t\t\t";
        // line 9
        $this->loadTemplate("partial/logoheader.html.twig", "admin/create.html.twig", 9)->display($context);
        // line 10
        echo "\t\t\t<!-- End Logo Header -->
            ";
        // line 11
        $this->loadTemplate("partial/navbar.html.twig", "admin/create.html.twig", 11)->display($context);
        // line 12
        echo "        </div>
        ";
        // line 13
        $this->loadTemplate("partial/sidebar.html.twig", "admin/create.html.twig", 13)->display($context);
        // line 14
...
\t\t\t\t\t\t\t\t\t\t\t\t<a class=\"btn btn-danger\" href=\"";
        // line 76
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 76, $this->source); })()), "request", [], "any", false, false, false, 76), "headers", [], "any", false, false, false, 76), "get", [0 => "referer"], "method", false, false, false, 76), "html", null, true);
        echo "\">";
...
";
    ...
    {
        return array (  229 => 83,  224 => 80,  215 => 76,  211 => 75,  201 => 68,  197 => 67,  191 => 64,  183 => 59,  179 => 58,  173 => 55,  165 => 50,  161 => 49,  155 => 46,  152 => 45,  147 => 42,  135 => 35,  126 => 29,  112 => 18,  106 => 14,  104 => 13,  101 => 12,  99 => 11,  96 => 10,  94 => 9,  89 => 6,  79 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}{{ 'create_admin'|trans }} {% endblock %}
...
\t\t\t\t<div class=\"container-fluid\">
\t\t\t\t\t<div class=\"page-header\">
\t\t\t\t\t\t<h4 class=\"page-title\">{{ 'administrator'|trans }} </h4>
\t\t\t\t\t\t<ul class=\"breadcrumbs\">
\t\t\t\t\t\t\t<li class=\"nav-home\">
\t\t\t\t\t\t\t\t<a href=\"#\">
\t\t\t\t\t\t\t\t\t<i class=\"flaticon-home\"></i>
...
\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t<li class=\"nav-item\">
\t\t\t\t\t\t\t\t<a href=\"#\">{{ 'create'|trans }} {{ 'administrator'|trans }} </a>
\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t</ul>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"row\">
...
{% endblock %}
", "admin/create.html.twig", "/Users/amine/Projects/manageTicket/templates/admin/create.html.twig");
    }
}
